...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        visited = [ False for s in self.corners]
        start_state = (self.startingPosition, tuple(visited))
        return start_state
    ...
    def getSuccessors(self, state: Any):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                visired_list = list(state[1])
                if (nextx,nexty) in self.corners:
                    visired_list[self.corners.index( (nextx,nexty) )] = True
            
                successorState = ( (nextx, nexty), tuple(visired_list) )
